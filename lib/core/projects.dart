...
List<Project> kProjects = [
  ...
  Project(
    title: "Meal Monkey",
    description:
        "A Restaurant & food delivery app with firebase backend. with all the features like user registration, login, food item list, cart, order history, payment, and much more.",
